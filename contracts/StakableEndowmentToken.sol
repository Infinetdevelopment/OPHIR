...
abstract contract StakableEndowmentToken is ERC20 {
    // Launch timeTime 
    // Apr 22 12AM GMT
    uint256 internal constant LAUNCH_TIME = 1682121600;  //The time of launch
    ...
    // The initial supply is 96 Trillion locked in the contract
    uint256 internal _endowmentSupply = (96 * 1e30);
